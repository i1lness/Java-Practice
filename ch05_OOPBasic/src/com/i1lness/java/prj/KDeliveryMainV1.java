...
public class KDeliveryMainV1 {
  ...
  public void selectOrderMenu() {
    ...
    System.out.println("주문자의 이름은 무엇인가요?");
    customerName = s.next();

    System.out.println("음식점의 상호는 무엇인가요?");
    shopName = s.next();
  ...
  public void selectFeedbackMenu() {
    ...
    System.out.println("음식 맛은 어떠하셨나요? (1 ~ 5 별점)");
    grade = s.nextInt();
  ...
  public static void main(String[] args) {
    ...
    do {
      ...
      switch (menu) {
        case 1:
          kd.selectAddShopMenu();
          break;
        case 2:
          kd.selectDashboardMenu();
          break;
        case 3:
          kd.selectOrderMenu();
          break;
        case 4:
          kd.selectFeedbackMenu();
          break;
      }
    } while (menu != 5);
