...
public class NovaPhone extends Phone {
  ...
  private static final String[] REGION_CODES = { "010", "011", "012", "016" };
  ...
  boolean validate(String serialNo) {
    if (serialNo == null) {
      System.out.println("일련 번호가 비어 있습니다, 개통실패");
      return false;
    }
    ...
    System.out.println("개통을 실패하였습니다");
    return false;
  }
  ...
  boolean call(String phoneNo) {
    ...
    for (String code : REGION_CODES) {
      if (phoneNo.startsWith(code)) {
        System.out.println(phoneNo + "로 통화 성공하셨습니다");
        return true;
      }
    }
